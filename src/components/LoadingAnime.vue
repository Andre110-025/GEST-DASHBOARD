<template>
  ...
  >
    <g>
      ...
      <circle cx="16.5" cy="4.21" r="1" fill="#fff">
        <animate
      ...
      <circle cx="7.5" cy="4.21" r="1" fill="#fff">
        <animate
      ...
      <circle cx="19.79" cy="7.5" r="1" fill="#fff">
        <animate
      ...
      <circle cx="4.21" cy="7.5" r="1" fill="#fff">
        <animate
      ...
      <circle cx="19.79" cy="16.5" r="1" fill="#fff">
        <animate
      ...
      <circle cx="4.21" cy="16.5" r="1" fill="#fff">
        <animate
      ...
      <circle cx="16.5" cy="19.79" r="1" fill="#fff">
        <animate
      ...
      <circle cx="7.5" cy="19.79" r="1" fill="#fff">
        <animate
